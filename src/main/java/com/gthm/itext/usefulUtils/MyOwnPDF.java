...
//             start generating the page number
    ...
    private static Table generateInvoiceTable() throws IOException {
        ...
        table.addCell(new Cell(2, 1).add(TableUtil.getTableHeader("TOTAL UNITS")))
             .setVerticalAlignment(VerticalAlignment.MIDDLE)
             .setTextAlignment(TextAlignment.CENTER);

        // 7th row
        table.addCell(new Cell(1, 4).add(TableUtil.getTableHeader("WEIGHT (KG)")))
             .setVerticalAlignment(VerticalAlignment.MIDDLE)
             .setTextAlignment(TextAlignment.CENTER);

        table.addCell(new Cell(2, 1).add(TableUtil.getTableHeader("PACK PRICE \n (USD)")))
             .setVerticalAlignment(VerticalAlignment.MIDDLE)
             .setTextAlignment(TextAlignment.CENTER);

        table.addCell(new Cell(2, 1).add(TableUtil.getTableHeader("AMOUNT IN \n USD")))
             .setVerticalAlignment(VerticalAlignment.MIDDLE)
             .setTextAlignment(TextAlignment.CENTER);

//         bottom ones
        table.addCell(new Cell(1, 1).add(TableUtil.getTableHeader("VNDR PACK TYPE")))
             .setVerticalAlignment(VerticalAlignment.MIDDLE)
             .setTextAlignment(TextAlignment.CENTER);

        table.addCell(new Cell(1, 1).add(TableUtil.getTableHeader("NET VNDR \n PACK")))
             .setVerticalAlignment(VerticalAlignment.MIDDLE)
             .setTextAlignment(TextAlignment.CENTER);

        table.addCell(new Cell(1, 1).add(TableUtil.getTableHeader("NET TOTAL")))
             .setVerticalAlignment(VerticalAlignment.MIDDLE)
             .setTextAlignment(TextAlignment.CENTER);

        table.addCell(new Cell(1, 1).add(TableUtil.getTableHeader("GROSS VNDR PACK")))
             .setVerticalAlignment(VerticalAlignment.MIDDLE)
             .setTextAlignment(TextAlignment.CENTER);

        table.addCell(new Cell(1, 1).add(TableUtil.getTableHeader("GROSS TOTAL")))
             .setVerticalAlignment(VerticalAlignment.MIDDLE)
             .setTextAlignment(TextAlignment.CENTER);
